import { Input, Component, OnInit, AfterViewInit, ViewEncapsulation, ViewChild, ComponentRef, ViewContainerRef, ComponentFactory, ComponentFactoryResolver, Compiler, ChangeDetectorRef } from '@angular/core';
